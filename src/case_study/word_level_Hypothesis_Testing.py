...
def process_data(data, data_type, alpha, alpha_smooth):
...
def save_results(test_word, save_dir, data_type):
    for pair in test_word:
...
def main():
    ...
    test_word = process_data(data, data_type, alpha, alpha_smooth)
    save_results(test_word, save_dir, data_type)
